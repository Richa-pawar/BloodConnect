<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="DonorRegister.aspx.cs" Inherits="Donor_DonorRegister" %>
...
<div class="card">
    ...
    <asp:RangeValidator runat="server" ControlToValidate="txtAge" MinimumValue="18" MaximumValue="120" Type="Integer" ErrorMessage="Age must be 18 or above" CssClass="validator" />
    ...
    <label>Address</label>
    <asp:TextBox ID="txtAddress" runat="server" TextMode="MultiLine" Rows="3" CssClass="textarea" />
    <asp:RequiredFieldValidator runat="server" ControlToValidate="txtAddress" ErrorMessage="Address is required" CssClass="validator" />

    <br /><br />
    <asp:Button ID="btnRegister" runat="server" Text="Register" CssClass="btn" OnClick="btnRegister_Click" />
    <a class="btn secondary" href="DonorLogin.aspx">Already Registered? Login</a>

    <br /><br />
    <a href="WhyDonate.aspx">Why Donate Blood</a> | <a href="WhoNeedsBlood.aspx">Who Needs Blood</a>
